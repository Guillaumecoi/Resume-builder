...
public class SectionControllerIntegrationTest {
    ...
    void testCreateAndGetResumeWithSections() throws Exception {
        // Arrange
        SectionSimpleCreateReq section1 = SectionSimpleCreateReq.builder().title("Education").build();
        SectionSimpleCreateReq section2 = SectionSimpleCreateReq.builder().title("Experience").build();
